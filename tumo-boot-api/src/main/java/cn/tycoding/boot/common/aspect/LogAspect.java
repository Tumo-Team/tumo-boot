package cn.tycoding.boot.common.aspect;

import cn.hutool.core.util.URLUtil;
import cn.hutool.extra.servlet.ServletUtil;
import cn.hutool.http.HttpUtil;
import cn.tycoding.boot.common.annotation.ApiLog;
import cn.tycoding.boot.common.event.LogEvent;
import cn.tycoding.boot.common.utils.SecurityUtil;
import cn.tycoding.boot.common.utils.SpringContextHolder;
...
public class LogAspect {
    ...
    public Object round(ProceedingJoinPoint point, ApiLog apiLog) throws JsonProcessingException {
        try {
